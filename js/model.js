...
defineModel("f1_60s", {
  ...
  parts : [
    ...
    /* ---------------- suspension ---------------- */
    { k:"box", c:"chrome", at:[-0.44,  1.20, 0.26], size:[0.52, 0.06, 0.05] },
    { k:"box", c:"chrome", at:[ 0.44,  1.20, 0.26], size:[0.52, 0.06, 0.05] },
    { k:"box", c:"chrome", at:[-0.46, -0.98, 0.30], size:[0.50, 0.07, 0.06] },
    { k:"box", c:"chrome", at:[ 0.46, -0.98, 0.30], size:[0.50, 0.07, 0.06] },
    ...
    /* ---------------- mirrors ---------------- */
    { k:"box", c:"chrome", at:[-0.34, 0.56, 0.70], size:[0.11, 0.05, 0.08] },
    { k:"box", c:"chrome", at:[ 0.34, 0.56, 0.70], size:[0.11, 0.05, 0.08] },

    /* ---------------- exhausts ---------------- */
    { k:"cyl", c:"chrome", axis:"y", sides:6, at:[-0.20, -1.52, 0.50],
      r:0.055, len:0.72 },
    { k:"cyl", c:"chrome", axis:"y", sides:6, at:[ 0.20, -1.52, 0.50],
      r:0.055, len:0.72 },

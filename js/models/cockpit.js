...
defineModel("cockpit_60s", {
  ...
  parts : [
    ...
    /* ---------------- nose running away ahead ----------------
       ...
       The deck height is the critical number.  The scuttle top sits about
       14 degrees below the eye; anything steeper than that is hidden behind
       it.  At G+0.44 the deck clears from y~0.95 outward, so the nose reads
       as a broad low wedge rather than a needle poking over the dash. */
